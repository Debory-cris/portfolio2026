...
export const metadata: Metadata = {
    title: "Contato — Débora Meireles",
    description: "Entre em contato com Débora Meireles — Frontend Developer & Art Director.",
};
...
const CONTACTS = [
    ...
    {
        label: "Email",
        description: "Me manda uma mensagem",
        ...
        <main className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-24">
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-slate-500 text-base md:text-lg max-w-md mx-auto leading-relaxed">
                    Estou aberta a projetos, colaborações e oportunidades.
